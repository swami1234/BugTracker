...
namespace BugTracker.Controllers
{
    ...
    public class TicketHistoriesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,TicketId,UserId,PropertyName,OldValue,NewValue,Upadated")] TicketHistory ticketHistory)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,TicketId,UserId,PropertyName,OldValue,NewValue,Upadated")] TicketHistory ticketHistory)
        {
            if (ModelState.IsValid)
            {
